# French Atelier · Batch 2 restoration check

Batch 1 is the locked presentation reference. The unapproved redesign has been removed from Batch 2; Batch 1 itself has not been modified.

## Restored without substitution

- All original CSS, including layout, colours, typography, phone styling and sizes.
- Original wordmark, by Acadomia treatment and favicon files.
- Original CTA labels: See the full story for content; Claim it now for promos.
- Original CTA destinations, button markup, metadata field labels and field order.
- Original preview/header arrangement, image manifest and download controls.
- Original Markdown handoff structure, including Notes and separators.

## Only retained changes

- New Batch 2 copy and literal subject headlines, with the school identified early.
- Previously corrected brief details: Quiche sensory sentence, Tour words within the story, verified Amélie vocabulary and coherent Monet imagery/copy.
- Brighter versions of the same eight approved compositions, still 1792 × 897.
- Separate 4096 × 2050 upscaled masters remain available; they do not alter the approved presentation.
- New Batch 2 identifiers and recomputed word counts.

## Copy measurements

| Message | Body words | Body characters | UTF-16 units | CTA |
|---|---:|---:|---:|---|
| 1 | 152 | 853 | 854 | See the full story |
| 2 | 154 | 816 | 817 | See the full story |
| 3 | 153 | 834 | 835 | Claim it now |
| 4 | 159 | 867 | 868 | Claim it now |
| 5 | 155 | 859 | 861 | See the full story |
| 6 | 155 | 849 | 850 | See the full story |
| 7 | 156 | 871 | 872 | See the full story |
| 8 | 155 | 837 | 838 | See the full story |

All bodies remain within 150 to 200 words. Header text is separate again, exactly as in the approved presentation.

## Verification boundary

Restoring the approved presentation does not establish live provider approval or Sandra's full ActiveCampaign specification. The original destinations are preserved, not independently certified as full-story pages or discount-redemption flows. Those observations do not authorize substituting CTA text or redesigning the handoff.


---

## Superseded audit of the earlier version

The audit below describes the earlier redesign, not the restored current presentation. Current copy counts and presentation status are specified above.
